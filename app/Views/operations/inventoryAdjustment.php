	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-12">
				...
				<input type="text" class="form-control" name="input_comentario" id="input_comentario" aria-describedby="emailHelp" placeholder="Comentario">
			</div>
			...
			<div class="col-12 table-responsive">
				...
				<table class="table m-0" id="tbl-addProduct" style="width: 100%;">
					<thead>
						<tr>
							<th>ID</th>
							<th>SUCURSAL</th>
							...
							<th class="text-right">NUEVA EXISTENCIA</th>
							<th>UNIDAD</th>
						</tr>
					</thead>
					<tbody>
		...
		<div class="row">
			...
			<div class="col-12">
				<button id="btn-guardar" type="button" class="btn btn-secondary btn-lg">GUARDAR</button>
			</div>
