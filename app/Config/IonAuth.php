...
class IonAuth extends \CodeIgniter\Config\BaseConfig
{
	...
	public $tables = [
		...
		'permissionGroup' => 'v_permissionGroup',
		'permissionGroupMenu' => 'v_permissionGroupMenu',
		'permissionGroupModule' => 'v_permissionGroupModule',
		'permissionStoreUser' => 'v_permissionStoreUser',
		'module'	=> 'module',
		'menu'	=> 'menu',
	];
